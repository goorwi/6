    ...
    public class Turing
    {
        ...
        private void GetRules()
        {
            if (direction == 1)
            {
                foreach (var rule in grammatic)
                {
                    ...
                    {
                        var to = r;
                        if (Regex.IsMatch(to, @"[a-z]{1}\b"))
                        {
                            to = r + "Z";
                        }
                        rules.Add(Tuple.Create(to, rule.Item1));
                    }
                }
            }
            else if (direction == 2)
        ...
        private string Work(string currentWord, bool isStart)
        {
            ...
            else if (isStart)
            {
                string part = "";
                if (direction == 1)
                    part = currentWord.Substring(a + 1, 1);
                else if (direction == 2)
                    part = currentWord.Substring(a, 1);
